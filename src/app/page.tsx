...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] font-sans overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 p-6 flex justify-between items-center max-w-full mx-auto bg-white/70 backdrop-blur-md border-b border-slate-200">
        ...
        <Link
          ...
          className="px-6 py-2.5 bg-blue-600 text-white font-black rounded-2xl hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30 transition-all active:scale-95"
        >
          Login
        </Link>
      </nav>
      ...
      <div className="relative z-10 container mx-auto pt-20 px-6 text-center">
        ...
        <p className="mt-6 text-slate-500 max-w-lg mx-auto text-lg">
          Master <span className="font-bold text-slate-800">OOP principles</span> through
          structural logic. The interactive way to learn Python.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-10 mt-20">
          <div className="group w-full max-w-[360px] bg-white border border-slate-200 p-2 rounded-[32px] hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 transition-all duration-500">
            <div className="p-6">
              ...
              <p className="text-slate-500 text-left text-sm leading-relaxed">
                Construct code blocks to master{" "}
                <span className="text-blue-600 font-semibold">OOP</span> and learn{" "}
                <span className="text-blue-600 font-semibold">Solid Principle</span>
              </p>
            </div>
          </div>
          ...
          <div className="group w-full max-w-[360px] bg-white border border-slate-200 p-2 rounded-[32px] hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-2 transition-all duration-500">
            <div className="p-6">
              ...
              <p className="text-slate-500 text-left text-sm leading-relaxed">
                Real-time collaborate with others to build{" "}
                <span className="text-blue-600 font-semibold">Scalable Software</span> with
                Jenga.
              </p>
            </div>
          </div>
        ...
        <div className="my-20">
          <Link
            href="/api/auth/signin"
            className="px-12 py-5 bg-blue-600 text-white font-black rounded-2xl hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30 transition-all"
          >
            START BUILDING NOW
          </Link>
        </div>
